...
function writeToFile(fileName, data) {
    ...
    },
    {
        ...
        choices: [ // TODO: generate each License onto README 
            'Apache license 2.0',
...
const generateReadme = (answers) => {
    return `<img alt="GitHub Followers" src="https://img.shields.io/github/followers/${answers.username}"> <img alt="GitHub License" src="https://img.shields.io/apm/l/vim-mode">  <img alt="GitHub Language Count" src="https://img.shields.io/github/languages/count/${answers.username}/${answers.repo}">  <img alt="Branch Check Main" src="https://img.shields.io/github/checks-status/${answers.username}/${answers.repo}/main">  <img alt="GitHub Commit Activity" src="https://img.shields.io/github/commit-activity/w/${answers.username}/${answers.repo}">
